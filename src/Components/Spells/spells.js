            ...
            <div><Header />
                <div className="container_box">
                    ...
                    <div class="container_li">
                        <Grid container>
                            <Grid item xl={3} md={3} lg={3} sm={3} xs={3}><h4 class="spellsize">SPELL</h4></Grid>
                            <Grid item xl={3} md={3} lg={3} sm={3} xs={3}><h4 class="spellsize">TYPE</h4></Grid>
                            <Grid item xl={6} md={6} lg={6} sm={6} xs={6}><h4 class="spellsize">EFFECT</h4></Grid>
                        </Grid>
